...
<div class="wrapper">
    ...
    <main>
        ...
        <section id="faqs-container">
            ...
            ?>
            <br>
            <div style="border: 2px solid var(--color-main-green); border-radius: 2rem; padding: 2rem 1rem;">
                <h4 style="margin-bottom: 1rem; color: var(--color-main-gray); font-size: 1.8rem;"><?= $faq->question; ?></h4>
                <p style="color: var(--color-medium-gray); font-size: 1.6rem;"><?= $faq->answer; ?></p>
            </div>
            <br>
                <?php
            }
