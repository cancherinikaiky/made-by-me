...
<nav class="menu">
    ...
    <a href="<?= url("app/criar") ?>">
        <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.4419 10L20.4419 30" stroke="#007444" stroke-width="2" stroke-linecap="square" stroke-linejoin="round"/>
            <path d="M30.4419 20L10.4419 20" stroke="#007444" stroke-width="2" stroke-linecap="square" stroke-linejoin="round"/>
        </svg>
    </a>
